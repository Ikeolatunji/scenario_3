...
This code is Line Following Robot following line a with Obstacle Avoidance, finding the shortest oathway and retruning back to the starting base.
...
2. Press the button labeled "A" on your robot to start the program.
3. The robot will begin following the black line using the line sensors.It would use this to know the lanes to avoid hitting th walls.
